...
class MinHeap {
    ...
    // Inserts a new key;
//    while inserting in the heap, adjustment to be made from leaf to node
//    While removing(heapify) from heap, adjustments has to be made top to bottom
...
//    while inserting in the heap, adjustment to be made from leaf to node
//    While removing from heap, adjustments has to be made top to bottom
